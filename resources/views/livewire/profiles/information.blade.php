        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="small mb-1" for="nom">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="small mb-1" for="nom">
                        {{ \App\Helpers\TranslationHelper::TranslateText('Prénom') }}</label>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="small mb-1" for="inputLocation">
                        {{ \App\Helpers\TranslationHelper::TranslateText('Téléphone') }}</label>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <label class="small mb-1" for="adresse">
                        {{ \App\Helpers\TranslationHelper::TranslateText('Adresse') }}</label>
