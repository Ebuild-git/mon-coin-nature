...
<head>
    ...
    <title> {{ \App\Helpers\TranslationHelper::TranslateText('Vérification de votre compte sur Mon Coin Nature') }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>{{ \App\Helpers\TranslationHelper::TranslateText('Merci de vous être inscrit sur Mon Coin Nature. Pour finaliser votre inscription et vérifier votre compte, veuillez utiliser le code de vérification ci-dessous
                ') }} :</p>
