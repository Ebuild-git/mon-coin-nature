				...
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-7">
							<h1 class="__title"><span>Mon Coin Nature</span> {{ \App\Helpers\TranslationHelper::TranslateText($produit->nom) }}</h1>
					...
					<div class="container">
						<div class="row">
							<div class="col-12 col-md-8 col-lg-9">
									...
									<div class="row">
										<div class="col-12 col-lg-7">
											<div class="__product-img">
												<img width="330" src="{{ Storage::url($produit->photo) }}" alt="demo" />
										...
										<div class="col-12 col-lg-5">
											<div class="content-container">
												<h3 class="__name">{{ \App\Helpers\TranslationHelper::TranslateText($produit->nom) }}</h3>

												<div class="__categories">
													{{ \App\Helpers\TranslationHelper::TranslateText('Categorie') }}:
													<span> {{ \App\Helpers\TranslationHelper::TranslateText(Str::limit($produit->categories->nom, 30)) }}  </span>
												</div>
												...
												<form class="__add-to-cart" action="#">
													<div class="quantity-counter js-quantity-counter">
														...
														<input class="__q-input qty text" type="number" name="quantite"
								...
								<h2>  {{ \App\Helpers\TranslationHelper::TranslateText('Les produits de la même categorie') }}</h2>
											...
											<div class="col-12 col-sm-6 col-lg-4">
												<div class="__item">
													<figure class="__image">
														<img class="lazy" width="180" src="{{ Storage::url($produit->photo) }}" data-src="{{ Storage::url($produit->photo) }}" alt="demo" />
													</figure>

													<div class="__content">
														<h4 class="h6 __title"><a  href="{{ route('details-produits', ['id' => $produit->id, 'slug' => Str::slug(Str::limit($produit->nom, 10))]) }}">{{ \App\Helpers\TranslationHelper::TranslateText(Str::limit($produit->nom, 15)) }}</a></h4>
