...
<br> <br>
                    ...
                    <div class="__inner">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg">
                                <div class="__item">
                                    <i class="__ico">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#ffbb4c" viewBox="-29 0 487 487.719">
        ...
        <section class="section">
            ...
            <div class="container">
                <div class="section-heading section-heading--left" data-aos="fade">
                    <h2 class="__title">{{ \App\Helpers\TranslationHelper::TranslateText('Produits') }} <span>{{ \App\Helpers\TranslationHelper::TranslateText('flash') }}</span></h2>
                </div>
 ...
 --}}
                                <a  class="custom-btn custom-btn--medium custom-btn--style-1" onclick="AddToCart( {{ $produit->id }} )">
                                    <i class="fontello-shopping-bag"></i> {{ \App\Helpers\TranslationHelper::TranslateText('Ajouter au panier') }}
                                </a>
                            </div>
