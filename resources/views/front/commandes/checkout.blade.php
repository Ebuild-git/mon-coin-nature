...
<!-- end hero -->
									...
									<div class="spacer py-3"></div>
										...
										<div class="row justify-content-xl-between">
											<div class="col-12 col-md-5 col-lg-6">
												<div><h6> {{ \App\Helpers\TranslationHelper::TranslateText('Informations personnelles') }}</h6></div>

												<div class="row">
													<div class="col-12 col-sm-6 col-md-12 col-lg-6">
														<div class="input-wrp">
															<input class="textfield"  name="nom"    @if (Auth::user()) value="{{ Auth::user()->nom }}" @endif  placeholder=" {{ \App\Helpers\TranslationHelper::TranslateText('Votre nom') }} *" type="text" required/>
														</div>
													</div>

													<div class="col-12 col-sm-6 col-md-12 col-lg-6">
														<div class="input-wrp">
															<input class="textfield"  name="prenom"    @if (Auth::user()) value="{{ Auth::user()->prenom }}" @endif  placeholder=" {{ \App\Helpers\TranslationHelper::TranslateText('Prénom') }} *" type="text" required />
														</div>
													</div>

													<div class="col-12 col-sm-6 col-md-12 col-lg-6">
														<div class="input-wrp">
                                                            <input type="mail" name="email" class="textfield"   @if (Auth::user()) value="{{ Auth::user()->email }}" @endif required/>
                                                        </div>
													</div>
                                                    ...
                                                    <div class="col-12">
														<div class="input-wrp">
                                                            <input type="text" name="adresse" class="textfield"    placeholder=" {{ \App\Helpers\TranslationHelper::TranslateText('Votre adresse') }}" required />  
                                                        </div>
													</div>
												</div>
												...
												<div class="row">
                                                    ...
                                                    <div class="col-12">
														<div class="input-wrp">
															<select class="textfield"  type="text"  name="gouvernorat" id="Region">
													...
													<div class="col-12">
														<div class="input-wrp">
															<textarea id="message" name="message" class="textfield" placeholder="{{ \App\Helpers\TranslationHelper::TranslateText('Note sur votre commande(Optionnel)') }}""></textarea>
														</div>
													</div>
												</div>
											...
											<div class="col-12 col-md-7 col-lg-6 col-xl-5">
												<div><h6>{{ \App\Helpers\TranslationHelper::TranslateText('Votre commande') }}</h6></div>
															...
															<tr>
																<td width="65%">
																	<div class="d-table">
																		...
																		<div class="d-table-cell align-middle">
																			<a href="#" class="__name">{{ $details['nom'] }}</a>
																		</div>
																	</div>
																</td>
												...
												<div class="checkout__total">
													<table>
														<thead>
															<tr>
																<td colspan="2"><h3> {{ \App\Helpers\TranslationHelper::TranslateText('Votre') }} <span> {{ \App\Helpers\TranslationHelper::TranslateText('commande') }}</span></h3></td>
															</tr>
														</thead>
																...
																<td colspan="2" class="__note">
																	...
																	<div class="content">
																		<div class="checkbox">
																			...
																			<form-group>
																				<input name="mode"  type="radio" value="livraison"> <label>Payement à la livraison</label><br><br>
																			
																				<input name="mode"  type="radio" value="solde"> <label> Payement  avec le solde </label>
																			</form-group>
 ...
 --}}
																	<button class="custom-btn custom-btn--medium custom-btn--style-1" type="submit" role="button">{{ \App\Helpers\TranslationHelper::TranslateText('Confirmation') }}</button>
																</td>
															</tr>
														</tfoot>
														...
														<tbody>
															...
															<tr>
																 <td>{{ \App\Helpers\TranslationHelper::TranslateText('Frais de livraison') }}</td>
																		...
																		@php
																			$chunkSize = 2; // Number of items per row
																			$chunks = $transports->chunk($chunkSize);
																		@endphp
																				...
																				@foreach ($chunk as $color)
																					<td>
																						<div class="form-check">
																							<input class="form-check-input" name="frais" type="checkbox"
