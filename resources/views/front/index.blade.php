...
<br>
                                    <p class="mt-5 mt-md-8">
                                                                                <span class="d-none d-sm-block" style="color: "><a class="custom-btn custom-btn--small custom-btn--style-2" href="{{ route('shop') }}"> {{ \App\Helpers\TranslationHelper::TranslateText('Voir boutique') }}</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
							...
							<div class="__inner">
								<div class="category-slider">
									...
									<div>
										...
										width="450" height="200"		 alt="{{ $category->name }}" 
										...
										<div class="__item">
											<i class="__ico">
												<div class="thumb image-center">
													<img src="{{ Storage::url($config->icone_satisfaction ?? '') }}" width="50" height="50" alt="Shape">
												</div>
    ...
    word-spacing: -1px; /* Ajuste l'espacement entre les mots */
											...
											<h4 class="__title h6">  {!! \App\Helpers\TranslationHelper::TranslateText($config->titre_satisfaction ?? ' ') !!}</h4>

											<span>   {!! \App\Helpers\TranslationHelper::TranslateText($config->des_satisfaction ?? '') !!}</span>
										</div>
									</div>
									<!-- end item -->
									...
									<div class="col-12 col-sm-6 col-lg">
										<div class="__item">
											<i class="__ico">
												<div class="thumb image-center">
													<img src="{{ Storage::url($config->icone_annee ?? '') }}" width="50" height="50" alt="Shape">
												</div>
										 ...
										 --}}	</i>
											...
											<h4 class="__title h6">{!! \App\Helpers\TranslationHelper::TranslateText($config->titre_annee ?? '') !!}</h4>

											<span>    {!! \App\Helpers\TranslationHelper::TranslateText($config->des_annee ?? ' ') !!}</span>
										</div>
									</div>
									<!-- end item -->
									...
									<div class="col-12 col-sm-6 col-lg">
										<div class="__item">
											<i class="__ico">
												<div class="thumb image-center">
													<img src="{{ Storage::url($config->icone_prix ?? ' ') }}" height="50" width="50" alt="Shape">
												</div>
		 ...
		 --}}									</i>
											...
											<h4 class="__title h6"> {!! \App\Helpers\TranslationHelper::TranslateText($config->titre_prix ?? ' ') !!}</h4>

											<span>  {!! \App\Helpers\TranslationHelper::TranslateText($config->des_prix ?? '') !!}.</span>
										</div>
									</div>
									<!-- end item -->
									...
									<div class="col-12 col-sm-6 col-lg">
										<div class="__item">
											<i class="__ico">
												<div class="thumb image-center">
													<img src="{{ Storage::url($config->image_apropos1 ?? ' ') }}" height="50" width="50" alt="Shape">
												</div>
								 ...
								 --}}			</i>
											...
											<h4 class="__title h6"> {!! \App\Helpers\TranslationHelper::TranslateText($config->titre_apropos1 ?? ' ') !!}</h4>

											<span> {!! \App\Helpers\TranslationHelper::TranslateText($config->des_apropos1 ?? ' ') !!}</span>
										</div>
									</div>
									<!-- end item -->
								</div>
    ...
    gap: 10px; /* Espace entre les éléments (optionnel) */
				...
				<section class="section section--no-pt">
					<div class="container">
						<div class="section-heading section-heading--center" data-aos="fade">
							<h2 class="__title">{{ \App\Helpers\TranslationHelper::TranslateText('Produits en promotion') }}💥</h2>
				...
				<!-- end section -->
					...
					<section class="section section--no-pt">
						<div class="container">
							<div class="section-heading section-heading--center" data-aos="fade">
								<h2 class="__title">{{ \App\Helpers\TranslationHelper::TranslateText('Bonne affaire') }}💥</h2>
